...
### 🔴 NEVER claim you don't have access/keys/info without CHECKING FILES FIRST!
Gilt für ALLES — API Keys, Configs, Daten, Passwörter, Notizen, frühere Entscheidungen.
Wenn es jemals eingerichtet wurde, existiert es als Datei. Workspace durchsuchen. Memory durchsuchen. Private-Ordner prüfen.
ERST suchen, DANN antworten. "Ich hab das nicht" ist KEINE akzeptable Antwort ohne vorherige Suche.
(Abmahnung Chris, 2026-02-19)
